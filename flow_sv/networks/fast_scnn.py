...
class MNV2_Flow_FastSCNN(nn.Module):
    def __init__(self, **kwargs):
        ...
        self.feature_fusion = FeatureFusionModule(feature_sizes[0], 128, 128)

        self.classifier = Classifer(128, 2)

    def forward(self, x):
        x, higher_res_features = self.encoder(x)
        x = self.ppm(x)
